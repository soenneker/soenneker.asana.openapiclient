...
namespace Soenneker.Asana.OpenApiClient.Models
{
    ...
    public partial class ProjectResponseCurrentStatus : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusAuthor? Author { get; set; }
#nullable restore
#else
        public global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusAuthor Author { get; set; }
#endif
        /// <summary>The color associated with the status update.</summary>
        public global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusColor? Color { get; set; }
        /// <summary>The time at which this resource was created.</summary>
        public DateTimeOffset? CreatedAt { get; private set; }
        /// <summary>A generic Asana Resource, containing a globally unique identifier.A generic Asana Resource, containing a globally unique identifier.A *user* object represents an account in Asana that can be given access to various workspaces, projects, and tasks.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusCreatedBy? CreatedBy { get; set; }
#nullable restore
#else
        public global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusCreatedBy CreatedBy { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatus"/> and sets the default values.
        /// </summary>
        public ProjectResponseCurrentStatus()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatus();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "author", n => { Author = n.GetObjectValue<global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusAuthor>(global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusAuthor.CreateFromDiscriminatorValue); } },
                { "color", n => { Color = n.GetEnumValue<global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusColor>(); } },
                { "created_at", n => { CreatedAt = n.GetDateTimeOffsetValue(); } },
                { "created_by", n => { CreatedBy = n.GetObjectValue<global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusCreatedBy>(global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusCreatedBy.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusAuthor>("author", Author);
            writer.WriteEnumValue<global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusColor>("color", Color);
            writer.WriteObjectValue<global::Soenneker.Asana.OpenApiClient.Models.ProjectResponseCurrentStatusCreatedBy>("created_by", CreatedBy);
