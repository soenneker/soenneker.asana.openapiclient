...
namespace Soenneker.Asana.OpenApiClient.Models
{
    ...
    public partial class RbacRoleResponse_permissions : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions_allowed_guest_invites? AllowedGuestInvites { get; set; }
        ...
        public global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions_task_deletion_policy? TaskDeletionPolicy { get; set; }
        /// <summary>Controls whether users with this role can upload attachments</summary>
        public bool? UploadAttachments { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions"/> and sets the default values.
        /// </summary>
        public RbacRoleResponse_permissions()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "task_deletion_policy", n => { TaskDeletionPolicy = n.GetEnumValue<global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions_task_deletion_policy>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Asana.OpenApiClient.Models.RbacRoleResponse_permissions_task_deletion_policy>("task_deletion_policy", TaskDeletionPolicy);
