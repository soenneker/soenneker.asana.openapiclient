...
using Soenneker.Asana.OpenApiClient.Time_tracking_entries.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Asana.OpenApiClient.Time_tracking_entries
{
    /// <summary>
    /// Builds and executes requests for operations under \time_tracking_entries
    /// </summary>
    ...
    public partial class Time_tracking_entriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.TimeTrackingEntryCompactArray?> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder.Time_tracking_entriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.TimeTrackingEntryCompactArray> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder.Time_tracking_entriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder.Time_tracking_entriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder.Time_tracking_entriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder WithUrl(string rawUrl)
        {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("attributable_to")]
...
#nullable restore
            ...
            public string AttributableTo { get; set; }
#endif
            /// <summary>The end date for filtering time tracking entries by when they were entered.</summary>
            [QueryParameter("entered_on_end_date")]
            public Date? EnteredOnEndDate { get; set; }
            /// <summary>The start date for filtering time tracking entries by when they were entered.</summary>
            [QueryParameter("entered_on_start_date")]
            public Date? EnteredOnStartDate { get; set; }
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.GetOpt_fieldsQueryParameterType[]? OptFieldsAsGetOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.GetOpt_fieldsQueryParameterType[] OptFieldsAsGetOptFieldsQueryParameterType { get; set; }
...
#nullable restore
            ...
            public string Portfolio { get; set; }
#endif
            /// <summary>Globally unique identifier for the task to filter time tracking entries by.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("task")]
...
#nullable restore
            ...
            public string Task { get; set; }
#endif
            /// <summary>Globally unique identifier for the timesheet approval status to filter time tracking entries by.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            public string User { get; set; }
#endif
            /// <summary>Globally unique identifier for the workspace. At least one of `entered_on_start_date` or `entered_on_end_date` must be provided when filtering by workspace.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Time_tracking_entriesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Time_tracking_entries.Time_tracking_entriesRequestBuilder.Time_tracking_entriesRequestBuilderGetQueryParameters>
        {
        }
    }
}
