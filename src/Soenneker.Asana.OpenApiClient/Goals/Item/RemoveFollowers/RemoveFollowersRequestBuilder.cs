...
namespace Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.GoalResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder.RemoveFollowersRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.GoalResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder.RemoveFollowersRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder.RemoveFollowersRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder.RemoveFollowersRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Removes followers from a goal. Returns the goal the followers were removed from.Each goal can be associated with zero or more followers in the system.Requests to add/remove followers, if successful, will return the complete updated goal record, described above.
        /// </summary>
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.PostOpt_fieldsQueryParameterType[]? OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.PostOpt_fieldsQueryParameterType[] OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RemoveFollowersRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveFollowers.RemoveFollowersRequestBuilder.RemoveFollowersRequestBuilderPostQueryParameters>
        {
        }
    }
}
