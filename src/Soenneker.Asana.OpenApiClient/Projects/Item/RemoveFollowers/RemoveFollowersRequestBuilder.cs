...
{
    /// <summary>
    /// Builds and executes requests for operations under \projects\{projectGid}\removeFollowers
    /// </summary>
    ...
    public partial class RemoveFollowersRequestBuilder : BaseRequestBuilder
    {
        ...
        public RemoveFollowersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectGid}/removeFollowers{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Projects.Item.RemoveFollowers.RemoveFollowersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveFollowersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectGid}/removeFollowers{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.RemoveFollowersForProjectOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.RemoveFollowersForProjectOptFieldsParameterItem[] OptFields { get; set; }
