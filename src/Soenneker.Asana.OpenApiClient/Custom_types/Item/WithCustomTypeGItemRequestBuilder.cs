...
{
    /// <summary>
    /// Builds and executes requests for operations under \custom_types\{customTypeGid}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithCustomTypeGItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCustomTypeGItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/custom_types/{customTypeGid}{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCustomTypeGItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/custom_types/{customTypeGid}{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.CustomTypeResponseData?> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder.WithCustomTypeGItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.CustomTypeResponseData> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder.WithCustomTypeGItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder.WithCustomTypeGItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder.WithCustomTypeGItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Custom_types.Item.WithCustomTypeGItemRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.GetCustomTypeOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.GetCustomTypeOptFieldsParameterItem[] OptFields { get; set; }
