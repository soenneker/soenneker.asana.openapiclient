...
{
    /// <summary>
    /// Builds and executes requests for operations under \project_templates\{projectTemplateGid}\instantiateProject
    /// </summary>
    ...
    public partial class InstantiateProjectRequestBuilder : BaseRequestBuilder
    {
        ...
        public InstantiateProjectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/project_templates/{projectTemplateGid}/instantiateProject{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Project_templates.Item.InstantiateProject.InstantiateProjectRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstantiateProjectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/project_templates/{projectTemplateGid}/instantiateProject{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.InstantiateProjectOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.InstantiateProjectOptFieldsParameterItem[] OptFields { get; set; }
