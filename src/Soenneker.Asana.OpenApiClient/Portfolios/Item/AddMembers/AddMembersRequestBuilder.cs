...
namespace Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.PortfolioResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder.AddMembersRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.PortfolioResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder.AddMembersRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder.AddMembersRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder.AddMembersRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Adds the specified list of users as members of the portfolio.Returns the updated portfolio record.
        /// </summary>
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.PostOpt_fieldsQueryParameterType[]? OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.PostOpt_fieldsQueryParameterType[] OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AddMembersRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.AddMembers.AddMembersRequestBuilder.AddMembersRequestBuilderPostQueryParameters>
        {
        }
    }
}
