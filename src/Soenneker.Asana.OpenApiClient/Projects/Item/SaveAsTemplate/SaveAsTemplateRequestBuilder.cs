...
namespace Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.JobResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplatePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder.SaveAsTemplateRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.JobResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplatePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder.SaveAsTemplateRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplatePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder.SaveAsTemplateRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplatePostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder.SaveAsTemplateRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Creates and returns a job that will asynchronously handle the project template creation.
        /// </summary>
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.PostOpt_fieldsQueryParameterType[]? OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.PostOpt_fieldsQueryParameterType[] OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SaveAsTemplateRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Projects.Item.SaveAsTemplate.SaveAsTemplateRequestBuilder.SaveAsTemplateRequestBuilderPostQueryParameters>
        {
        }
    }
}
