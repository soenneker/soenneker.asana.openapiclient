...
{
    /// <summary>
    /// Builds and executes requests for operations under \tasks\{taskGid}\addDependents
    /// </summary>
    ...
    public partial class AddDependentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public AddDependentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tasks/{taskGid}/addDependents", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddDependents.AddDependentsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddDependentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tasks/{taskGid}/addDependents", rawUrl)
        {
        }
        /// <summary>
