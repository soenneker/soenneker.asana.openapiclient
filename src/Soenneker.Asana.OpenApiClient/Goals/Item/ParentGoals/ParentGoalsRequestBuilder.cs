...
{
    /// <summary>
    /// Builds and executes requests for operations under \goals\{goalGid}\parentGoals
    /// </summary>
    ...
    public partial class ParentGoalsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ParentGoalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/goals/{goalGid}/parentGoals{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Goals.Item.ParentGoals.ParentGoalsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentGoalsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/goals/{goalGid}/parentGoals{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.GetParentGoalsForGoalOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.GetParentGoalsForGoalOptFieldsParameterItem[] OptFields { get; set; }
