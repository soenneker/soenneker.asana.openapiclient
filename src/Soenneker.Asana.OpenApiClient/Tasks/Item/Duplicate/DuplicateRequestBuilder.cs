...
{
    /// <summary>
    /// Builds and executes requests for operations under \tasks\{taskGid}\duplicate
    /// </summary>
    ...
    public partial class DuplicateRequestBuilder : BaseRequestBuilder
    {
        ...
        public DuplicateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tasks/{taskGid}/duplicate{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Tasks.Item.Duplicate.DuplicateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DuplicateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tasks/{taskGid}/duplicate{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.DuplicateTaskOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.DuplicateTaskOptFieldsParameterItem[] OptFields { get; set; }
