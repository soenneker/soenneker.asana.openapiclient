...
namespace Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.DeprecatedPortfolioMembershipResponseArray?> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder.Portfolio_membershipsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.DeprecatedPortfolioMembershipResponseArray> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder.Portfolio_membershipsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder.Portfolio_membershipsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder.Portfolio_membershipsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns the compact portfolio membership records for the portfolio.
        /// </summary>
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.GetOpt_fieldsQueryParameterType[]? OptFieldsAsGetOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.GetOpt_fieldsQueryParameterType[] OptFieldsAsGetOptFieldsQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Portfolio_membershipsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Portfolios.Item.Portfolio_memberships.Portfolio_membershipsRequestBuilder.Portfolio_membershipsRequestBuilderGetQueryParameters>
        {
        }
    }
}
