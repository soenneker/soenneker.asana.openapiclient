...
using Soenneker.Asana.OpenApiClient.Teams.Item;
...
namespace Soenneker.Asana.OpenApiClient.Teams
{
    ...
    public partial class TeamsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/teams{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.TeamResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Teams.TeamsPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder.TeamsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.TeamResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Teams.TeamsPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder.TeamsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Teams.TeamsPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder.TeamsRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Teams.TeamsPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder.TeamsRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Creates a team within the current workspace.
        /// </summary>
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Teams.PostOpt_fieldsQueryParameterType[]? OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Teams.PostOpt_fieldsQueryParameterType[] OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TeamsRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Teams.TeamsRequestBuilder.TeamsRequestBuilderPostQueryParameters>
        {
        }
    }
}
