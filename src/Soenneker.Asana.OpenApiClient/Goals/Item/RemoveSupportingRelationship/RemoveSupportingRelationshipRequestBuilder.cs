...
namespace Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.EmptyResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.EmptyResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveSupportingRelationship.RemoveSupportingRelationshipRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RemoveSupportingRelationshipRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
