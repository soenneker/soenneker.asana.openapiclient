...
{
    /// <summary>
    /// Builds and executes requests for operations under \projects\{projectGid}\addFollowers
    /// </summary>
    ...
    public partial class AddFollowersRequestBuilder : BaseRequestBuilder
    {
        ...
        public AddFollowersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectGid}/addFollowers{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Projects.Item.AddFollowers.AddFollowersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddFollowersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectGid}/addFollowers{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.AddFollowersForProjectOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.AddFollowersForProjectOptFieldsParameterItem[] OptFields { get; set; }
