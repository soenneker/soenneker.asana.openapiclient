...
#nullable restore
            ...
            /// <summary>Filter to events with an actor of this type.This only needs to be included if querying for actor types without an ID. If `actor_gid` is included, this should be excluded.</summary>
            [QueryParameter("actor_type")]
            public global::Soenneker.Asana.OpenApiClient.Workspaces.Item.Audit_log_events.GetActor_typeQueryParameterType? ActorTypeAsGetActorTypeQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Audit_log_eventsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Workspaces.Item.Audit_log_events.Audit_log_eventsRequestBuilder.Audit_log_eventsRequestBuilderGetQueryParameters>
        {
        }
    }
}
