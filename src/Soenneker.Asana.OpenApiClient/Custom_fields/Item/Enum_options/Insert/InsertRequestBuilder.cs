...
{
    /// <summary>
    /// Builds and executes requests for operations under \custom_fields\{customFieldGid}\enum_options\insert
    /// </summary>
    ...
    public partial class InsertRequestBuilder : BaseRequestBuilder
    {
        ...
        public InsertRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/custom_fields/{customFieldGid}/enum_options/insert{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Custom_fields.Item.Enum_options.Insert.InsertRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InsertRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/custom_fields/{customFieldGid}/enum_options/insert{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.InsertEnumOptionForCustomFieldOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.InsertEnumOptionForCustomFieldOptFieldsParameterItem[] OptFields { get; set; }
