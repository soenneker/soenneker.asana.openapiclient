...
using Soenneker.Asana.OpenApiClient.User_task_lists.Item.Tasks;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Asana.OpenApiClient.User_task_lists.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \user_task_lists\{userTaskListGid}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithUserTaskListGItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The tasks property</summary>
        public global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.Tasks.TasksRequestBuilder Tasks
        {
            get => new global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.Tasks.TasksRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserTaskListGItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user_task_lists/{userTaskListGid}{?opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUserTaskListGItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user_task_lists/{userTaskListGid}{?opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.UserTaskListResponseData?> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder.WithUserTaskListGItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.UserTaskListResponseData> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder.WithUserTaskListGItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder.WithUserTaskListGItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder.WithUserTaskListGItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.User_task_lists.Item.WithUserTaskListGItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// &quot;&lt;b&gt;Required scope: &lt;/b&gt;&lt;code&gt;tasks:read&lt;/code&gt;Returns the full record for a user task list.&quot;
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithUserTaskListGItemRequestBuilderGetQueryParameters 
        {
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.GetUserTaskListOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.GetUserTaskListOptFieldsParameterItem[] OptFields { get; set; }
