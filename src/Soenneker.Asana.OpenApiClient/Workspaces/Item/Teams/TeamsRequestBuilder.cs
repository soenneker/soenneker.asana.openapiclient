...
{
    /// <summary>
    /// Builds and executes requests for operations under \workspaces\{workspaceGid}\teams
    /// </summary>
    ...
    public partial class TeamsRequestBuilder : BaseRequestBuilder
    {
        ...
        public TeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/workspaces/{workspaceGid}/teams{?limit*,offset*,opt_fields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Workspaces.Item.Teams.TeamsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TeamsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/workspaces/{workspaceGid}/teams{?limit*,offset*,opt_fields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
            ...
            public global::Soenneker.Asana.OpenApiClient.Models.GetTeamsForWorkspaceOptFieldsParameterItem[]? OptFields { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Models.GetTeamsForWorkspaceOptFieldsParameterItem[] OptFields { get; set; }
