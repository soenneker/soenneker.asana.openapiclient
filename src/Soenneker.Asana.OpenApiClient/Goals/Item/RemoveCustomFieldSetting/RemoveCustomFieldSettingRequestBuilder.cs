...
{
    /// <summary>
    /// Builds and executes requests for operations under \goals\{goalGid}\removeCustomFieldSetting
    /// </summary>
    ...
    public partial class RemoveCustomFieldSettingRequestBuilder : BaseRequestBuilder
    {
        ...
        public RemoveCustomFieldSettingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/goals/{goalGid}/removeCustomFieldSetting", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Goals.Item.RemoveCustomFieldSetting.RemoveCustomFieldSettingRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveCustomFieldSettingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/goals/{goalGid}/removeCustomFieldSetting", rawUrl)
        {
        }
        /// <summary>
