...
namespace Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.WorkspaceMembershipResponseArray?> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder.Workspace_membershipsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.WorkspaceMembershipResponseArray> GetAsync(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder.Workspace_membershipsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Asana.OpenApiClient.Models.WorkspaceMembershipResponseArray>(requestInfo, global::Soenneker.Asana.OpenApiClient.Models.WorkspaceMembershipResponseArray.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns the compact workspace membership records for the user.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder.Workspace_membershipsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder.Workspace_membershipsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns the compact workspace membership records for the user.
        /// </summary>
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.GetOpt_fieldsQueryParameterType[]? OptFieldsAsGetOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.GetOpt_fieldsQueryParameterType[] OptFieldsAsGetOptFieldsQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Workspace_membershipsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Users.Item.Workspace_memberships.Workspace_membershipsRequestBuilder.Workspace_membershipsRequestBuilderGetQueryParameters>
        {
        }
    }
}
