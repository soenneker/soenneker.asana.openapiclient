...
namespace Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.TaskResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder.AddFollowersRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.TaskResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder.AddFollowersRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder.AddFollowersRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersPostRequestBody body, Action<RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder.AddFollowersRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable enable
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.PostOpt_fieldsQueryParameterType[]? OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("opt_fields")]
            public global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.PostOpt_fieldsQueryParameterType[] OptFieldsAsPostOptFieldsQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AddFollowersRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Soenneker.Asana.OpenApiClient.Tasks.Item.AddFollowers.AddFollowersRequestBuilder.AddFollowersRequestBuilderPostQueryParameters>
        {
        }
    }
}
