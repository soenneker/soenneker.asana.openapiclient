...
namespace Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Models.RuleTriggerResponseData"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.RuleTriggerResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.RuleTriggerResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Asana.OpenApiClient.Models.RuleTriggerResponseData>(requestInfo, global::Soenneker.Asana.OpenApiClient.Models.RuleTriggerResponseData.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Trigger a rule which uses an [&quot;incoming web request&quot;](/docs/incoming-web-requests) trigger.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Rule_triggers.Item.Run.RunRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
