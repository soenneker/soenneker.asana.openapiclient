...
namespace Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.EmptyResponseData?> PostAsync(global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Asana.OpenApiClient.Models.EmptyResponseData> PostAsync(global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Asana.OpenApiClient.Tasks.Item.RemoveTag.RemoveTagRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
